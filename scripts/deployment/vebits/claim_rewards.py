...
def main():
    ...
    tx1 = voting_escrow.claim_rewards({"from": user1})
    print(f"{tx1.events['UserRewardsClaimed']=}")

    tx2 = voting_escrow.claim_rewards({"from": user2})
    print(f"{tx2.events['UserRewardsClaimed']=}")
